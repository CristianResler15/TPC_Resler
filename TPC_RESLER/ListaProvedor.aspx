<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ListaProvedor.aspx.cs" Inherits="TPC_RESLER.ListaProvedor" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
   ...
   <div class="GirdAlineado right">
        ...
        <br />  
        <br />  
        <asp:GridView CssClass=" table GirdAlineado " ID="dgvProv" runat="server" AutoGenerateColumns="false" OnSelectedIndexChanged="dgvProv_SelectedIndexChanged" OnRowCommand="dgvProv_RowCommand">
            <Columns>
